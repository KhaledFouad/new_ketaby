...
abstract class AppStyles {
  static final textStyle10 = TextStyle(fontSize: 8.sp, color: AppColors.white);
  static final textStyle12 = TextStyle(fontSize: 10.sp, color: AppColors.white);
  static final textStyle14 = TextStyle(fontSize: 12.sp);
  static final textStyle15 = TextStyle(fontSize: 13.sp);
  ...
  static final textStyle18 = TextStyle(fontSize: 16.sp);
  ...
  static final textStyle25 = TextStyle(fontSize: 23.sp, color: AppColors.white);
